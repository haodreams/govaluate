...
type evaluationOperator func(left interface{}, right interface{}, parameters Parameters, funcName string) (interface{}, error)
...
func noopStageRight(left interface{}, right interface{}, parameters Parameters, funcName string) (interface{}, error) {
	return right, nil
}

func addStage(left interface{}, right interface{}, parameters Parameters, funcName string) (interface{}, error) {
...
func subtractStage(left interface{}, right interface{}, parameters Parameters, funcName string) (interface{}, error) {
	return left.(float64) - right.(float64), nil
}
func multiplyStage(left interface{}, right interface{}, parameters Parameters, funcName string) (interface{}, error) {
	return left.(float64) * right.(float64), nil
}
func divideStage(left interface{}, right interface{}, parameters Parameters, funcName string) (interface{}, error) {
	return left.(float64) / right.(float64), nil
}
func exponentStage(left interface{}, right interface{}, parameters Parameters, funcName string) (interface{}, error) {
	return math.Pow(left.(float64), right.(float64)), nil
}
func modulusStage(left interface{}, right interface{}, parameters Parameters, funcName string) (interface{}, error) {
	return math.Mod(left.(float64), right.(float64)), nil
}
func gteStage(left interface{}, right interface{}, parameters Parameters, funcName string) (interface{}, error) {
	if isString(left) && isString(right) {
		return boolIface(left.(string) >= right.(string)), nil
	}
	return boolIface(left.(float64) >= right.(float64)), nil
}
func gtStage(left interface{}, right interface{}, parameters Parameters, funcName string) (interface{}, error) {
	if isString(left) && isString(right) {
		return boolIface(left.(string) > right.(string)), nil
	}
	return boolIface(left.(float64) > right.(float64)), nil
}
func lteStage(left interface{}, right interface{}, parameters Parameters, funcName string) (interface{}, error) {
	if isString(left) && isString(right) {
		return boolIface(left.(string) <= right.(string)), nil
	}
	return boolIface(left.(float64) <= right.(float64)), nil
}
func ltStage(left interface{}, right interface{}, parameters Parameters, funcName string) (interface{}, error) {
	if isString(left) && isString(right) {
		return boolIface(left.(string) < right.(string)), nil
	}
	return boolIface(left.(float64) < right.(float64)), nil
}
func equalStage(left interface{}, right interface{}, parameters Parameters, funcName string) (interface{}, error) {
	return boolIface(reflect.DeepEqual(left, right)), nil
}
func notEqualStage(left interface{}, right interface{}, parameters Parameters, funcName string) (interface{}, error) {
	return boolIface(!reflect.DeepEqual(left, right)), nil
}
func andStage(left interface{}, right interface{}, parameters Parameters, funcName string) (interface{}, error) {
	return boolIface(left.(bool) && right.(bool)), nil
}
func orStage(left interface{}, right interface{}, parameters Parameters, funcName string) (interface{}, error) {
	return boolIface(left.(bool) || right.(bool)), nil
}
func negateStage(left interface{}, right interface{}, parameters Parameters, funcName string) (interface{}, error) {
	return -right.(float64), nil
}
func invertStage(left interface{}, right interface{}, parameters Parameters, funcName string) (interface{}, error) {
	return boolIface(!right.(bool)), nil
}
func bitwiseNotStage(left interface{}, right interface{}, parameters Parameters, funcName string) (interface{}, error) {
	return float64(^int64(right.(float64))), nil
}
func ternaryIfStage(left interface{}, right interface{}, parameters Parameters, funcName string) (interface{}, error) {
	if left.(bool) {
		return right, nil
	}
	return nil, nil
}
func ternaryElseStage(left interface{}, right interface{}, parameters Parameters, funcName string) (interface{}, error) {
	if left != nil {
		return left, nil
	}
	return right, nil
...
func regexStage(left interface{}, right interface{}, parameters Parameters, funcName string) (interface{}, error) {
...
func notRegexStage(left interface{}, right interface{}, parameters Parameters, funcName string) (interface{}, error) {

	ret, err := regexStage(left, right, parameters, funcName)
	if err != nil {
		return nil, err
	}
...
func bitwiseOrStage(left interface{}, right interface{}, parameters Parameters, funcName string) (interface{}, error) {
	return float64(int64(left.(float64)) | int64(right.(float64))), nil
}
func bitwiseAndStage(left interface{}, right interface{}, parameters Parameters, funcName string) (interface{}, error) {
	return float64(int64(left.(float64)) & int64(right.(float64))), nil
}
func bitwiseXORStage(left interface{}, right interface{}, parameters Parameters, funcName string) (interface{}, error) {
	return float64(int64(left.(float64)) ^ int64(right.(float64))), nil
}
func leftShiftStage(left interface{}, right interface{}, parameters Parameters, funcName string) (interface{}, error) {
	return float64(uint64(left.(float64)) << uint64(right.(float64))), nil
}
func rightShiftStage(left interface{}, right interface{}, parameters Parameters, funcName string) (interface{}, error) {
	return float64(uint64(left.(float64)) >> uint64(right.(float64))), nil
}

func makeParameterStage(parameterName string) evaluationOperator {

	return func(left interface{}, right interface{}, parameters Parameters, funcName string) (interface{}, error) {
		value, err := parameters.Get(parameterName, funcName)
		if err != nil {
			return nil, err
		}
...
func makeAccessorStage(pair []string) evaluationOperator {
	...
	return func(left interface{}, right interface{}, parameters Parameters, funcName string) (ret interface{}, err error) {

		var params []reflect.Value

		value, err := parameters.Get(pair[0], funcName)
		if err != nil {
			return nil, err
		}
...
func separatorStage(left interface{}, right interface{}, parameters Parameters, funcName string) (interface{}, error) {
...
func inStage(left interface{}, right interface{}, parameters Parameters, funcName string) (interface{}, error) {
